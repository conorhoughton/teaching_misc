...
the library of commands related to turtle, \lnn{5} prevents the
computer from closing the graphics window when the programme has
...
\turtle is from the library it imported in \lnn{1}. In the
